...
export const mockStores: Store[] = [
  { id: STORE_IDS[0], organization_id: ORG_ID, name: "Seoul Station Branch", code: "SES", address: "서울특별시 중구 세종대로 12", phone: null, email: null, status: "open", sort_order: 0, is_active: true, require_approval: true, operating_hours: null, day_start_time: null, max_work_hours_weekly: null, state_code: null, timezone: null, default_hourly_rate: null, accepting_signups: true, created_at: "2025-06-01T09:00:00Z" },
  { id: STORE_IDS[1], organization_id: ORG_ID, name: "Gangnam Branch", code: "GAN", address: "서울특별시 강남구 테헤란로 123", phone: null, email: null, status: "open", sort_order: 1, is_active: true, require_approval: true, operating_hours: null, day_start_time: null, max_work_hours_weekly: null, state_code: null, timezone: null, default_hourly_rate: null, accepting_signups: true, created_at: "2025-07-15T10:00:00Z" },
  { id: STORE_IDS[2], organization_id: ORG_ID, name: "Busan Branch", code: "BUS", address: "부산광역시 해운대구 센텀로 45", phone: null, email: null, status: "paused", sort_order: 2, is_active: false, require_approval: true, operating_hours: null, day_start_time: null, max_work_hours_weekly: null, state_code: null, timezone: null, default_hourly_rate: null, accepting_signups: true, created_at: "2025-08-20T11:00:00Z" },
];
